    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ...
                ('final_accomodation_adjustments', models.CharField(blank=True, max_length=150, null=True)),
                ...
                ('final_food_adjustments', models.CharField(blank=True, max_length=150, null=True)),
                ...
                ('vehicle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='trips', to='vehicle_service.vehicle')),
            ],
        ),
        migrations.CreateModel(
            name='Food',
